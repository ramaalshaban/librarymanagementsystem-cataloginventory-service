...
describe("BranchInventoryManager", () => {
  let ManagerClass;
  let manager;
  let req;
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/BranchInventory/BranchInventoryManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "branchInventory");
      expect(instance).to.have.property("modelName", "BranchInventory");
