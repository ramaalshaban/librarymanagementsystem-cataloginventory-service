...
describe("PurchaseOrderManager", () => {
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/PurchaseOrder/PurchaseOrderManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "purchaseOrder");
      expect(instance).to.have.property("modelName", "PurchaseOrder");
