...
console.log(
  "Starting librarymanagementsystem-cataloginventory-service service...",
);
...
const start = async () => {
  process.title = "node-librarymanagementsystem-cataloginventory-service";
  ...
  try {
    ...
    await setRedisData(
      "librarymanagementsystem-cataloginventory-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key librarymanagementsystem-cataloginventory-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "librarymanagementsystem-cataloginventory-service is listening HTTP/REST port " +
...
/* starting the server librarymanagementsystem-cataloginventory-service .... */
start();
