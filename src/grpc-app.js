...
const catalogInventoryPackage = grpcObject.catalogInventory;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is librarymanagementsystem-cataloginventory-service",
  });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(catalogInventoryPackage.catalogInventoryService.service, {
  helloMessage,
  ...sessionRouter,
});
