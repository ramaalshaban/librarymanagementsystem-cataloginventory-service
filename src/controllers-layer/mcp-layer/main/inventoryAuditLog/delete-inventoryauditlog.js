...
class DeleteInventoryAuditLogMcpController extends CatalogInventoryMcpController {
  constructor(params) {
    super("deleteInventoryAuditLog", "deleteinventoryauditlog", params);
    this.dataName = "inventoryAuditLog";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteInventoryAuditLogManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteInventoryAuditLogMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteInventoryAuditLogMcpController =
        new DeleteInventoryAuditLogMcpController(mcpParams);
      try {
        const result =
          await deleteInventoryAuditLogMcpController.processRequest();
        //return DeleteInventoryAuditLogMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
