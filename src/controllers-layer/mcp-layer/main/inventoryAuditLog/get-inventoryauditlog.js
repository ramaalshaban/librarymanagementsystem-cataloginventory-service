...
class GetInventoryAuditLogMcpController extends CatalogInventoryMcpController {
  constructor(params) {
    super("getInventoryAuditLog", "getinventoryauditlog", params);
    this.dataName = "inventoryAuditLog";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetInventoryAuditLogManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetInventoryAuditLogMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getInventoryAuditLogMcpController =
        new GetInventoryAuditLogMcpController(mcpParams);
      try {
        const result = await getInventoryAuditLogMcpController.processRequest();
        //return GetInventoryAuditLogMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
