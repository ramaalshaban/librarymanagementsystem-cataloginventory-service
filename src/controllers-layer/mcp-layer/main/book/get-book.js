...
class GetBookMcpController extends CatalogInventoryMcpController {
  constructor(params) {
    super("getBook", "getbook", params);
    this.dataName = "book";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetBookManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetBookMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getBookMcpController = new GetBookMcpController(mcpParams);
      try {
        const result = await getBookMcpController.processRequest();
        //return GetBookMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
