...
class DeleteBranchMcpController extends CatalogInventoryMcpController {
  constructor(params) {
    super("deleteBranch", "deletebranch", params);
    this.dataName = "branch";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteBranchManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteBranchMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteBranchMcpController = new DeleteBranchMcpController(
        mcpParams,
      );
      try {
        const result = await deleteBranchMcpController.processRequest();
        //return DeleteBranchMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
